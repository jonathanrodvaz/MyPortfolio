        ...
        <motion.div
                ...
                <div className='md:flex md:justify-between gap-16 mt-5'>
                    ...
                    >
                        ...
                        target='_blank'
                        onSubmit={onSubmit}
                        action='https://formsubmit.co/aquivatudirecciondemail@gmail.com'
                        method='POST'
                        >
                            <input 
                            className='w-full bg-greyblue font-semibold placeholder-opaque-black p-3'
                            type='text'
                            placeholder='NAME'
                            {...register('name', {
                                required: true,
                            ...
                            <input 
                            className='w-full bg-greyblue font-semibold placeholder-opaque-black p-3 mt-5'
                            type='text'
                            placeholder='EMAIL'
                            {...register('email', {
                                required: true,
